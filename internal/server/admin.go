...
func RouteHandler(router *mapper2.Router) func(rw http.ResponseWriter, r *http.Request) {
...
func RequestsHandler(router *mapper2.Router) func(rw http.ResponseWriter, r *http.Request) {
...
func encodeResponse(router *mapper2.Router, r *http.Request, rw http.ResponseWriter) {
...
func StartAdminServer(port int, r *mapper2.Router) {
