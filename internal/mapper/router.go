...
import (
    ...
    request2 "github.com/Eldius/mock-server-go/internal/request"
    "net/http"
    "os"
    "strings"
...
*/
func (r *Router) AddRequest(req *request2.Record) *Router {
    request2.Persist(req)
    return r
}
...
func (r *Router) Handle(rw http.ResponseWriter, req *http.Request) {
    ...
    if mapping != nil {
        ...
        record.Response = request2.ResponseRecord{
            Code: 404,
...
func (r *Router) GetRequests() []request2.Record {
    return request2.GetRequests()
}
